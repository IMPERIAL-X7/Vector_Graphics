...
std::shared_ptr<GraphicsObject> Hexagon::loadShape(const std::string& s1, const std::string& s2)
{
    auto style_ = style(s1);
    auto hexagon = std::make_shared<Hexagon>(style_.stroke, style_.fill, style_.strokeWidth);
