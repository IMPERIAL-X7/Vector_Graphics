...
std::shared_ptr<GraphicsObject> Line::loadShape(const std::string& s1, const std::string& s2)
{
    auto style_ = style(s1);
    auto line = std::make_shared<Line>(style_.stroke, style_.fill, style_.strokeWidth);
